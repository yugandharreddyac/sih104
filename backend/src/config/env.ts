...
const envSchema = z.object({
  ...
  JWT_SECRET: isProd ? z.string().min(16) : z.string().min(16).default('voxshield_super_secure_jwt_secret_dev_key_2026!'),
  ...
  ENCRYPTION_KEY: isProd ? z.string().min(32) : z.string().min(32).default('0123456789abcdef0123456789abcdef'), // 32 bytes for AES-256
  ...
  WEBHOOK_SECRET: isProd ? z.string().min(16) : z.string().min(16).default('voxshield_default_dev_webhook_secret_2026'),
