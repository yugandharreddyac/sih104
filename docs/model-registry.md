...
| `replay_spectral_decay_v3` | REPLAY | 3.0.1 | NUMPY_DSP | `NOT_APPLICABLE` | NONE (Deterministic DSP / Heuristic Fallback - No Training Dataset) | **AVAILABLE (DSP/Heuristic Fallback; Trained Model NOT AVAILABLE)** |
