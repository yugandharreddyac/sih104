...
The model checkpoint was downloaded and staged under [ai/models/asr/faster-whisper-base/](../ai/models/asr/faster-whisper-base/):
...
* **Git Tracking Policy:** Model binaries and large artifacts are ignored by [.gitignore](../.gitignore).

---

## 6. Model Registry Integration

Updated [ai/app/core/model_registry.py](../ai/app/core/model_registry.py) with official entries and real SHA-256 checksum verification:
...
3. **Privacy Invariant:** In-flight audio transcripts pass directly to [SensitiveDataDetector](../ai/app/sensitive_data/detector.py) where OTPs, passwords, and CVVs are masked before persistence.
